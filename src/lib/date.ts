 ...
 */
export function formatDateToYYYYMMDD(date: Date | string | number | undefined): string {
 ...
 */
export function formatDateToDDMMYY(date: Date | string | number | undefined): string {
